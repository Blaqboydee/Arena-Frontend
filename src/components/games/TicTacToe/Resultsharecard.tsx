...
// Avatar initials circle — mirrors your existing Avatar component styling
// but inlined so html-to-image captures it without external class dependencies.
...
export default function ResultShareCard({ matchOver, players, myId, cardRef }: Props) {
  ...
  const tagline = isDraw
    ...
    : `${matchOver.winnerName} takes this one.`;

  return (
    // Positioned off-screen — only used as an html-to-image render target
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
            ...
            <span style={{ fontSize: 11, color: "#4b5563", letterSpacing: "0.08em" }}>
              TIC TAC TOE · {matchOver.totalRounds} ROUND{matchOver.totalRounds !== 1 ? "S" : ""}
            </span>
          </div>
        </div>
